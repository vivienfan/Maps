...
module.exports = function makeDataHelpers(knex) {
  return {
    ...
    // getAllPublicListsExcept: function(uid, callback) {
    //   console.log('-------------get all public lists except:', uid);
    //   knex
    //   .select('title', 'description')
    //   .from('lists')
    //   .where('public', true)
    //   .whereNotIn('l_id', function() {
    //     this
    //     .distinct('l_id')
    //     .from(contributions)
    //     .where('u_id', uid);
    ...
    getAllFavouritesByUserId: function(uid, callback) {
    ...
    getContributionsByUserId: function(uid, callback) {
      console.log('-------------get contributions:', uid);
      knex
      .select('title', 'description')
      .from('lists')
      .whereIn('l_id', function() {
