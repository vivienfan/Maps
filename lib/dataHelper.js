...
module.exports = function makeDataHelpers(knex) {
  return {
    ...
    getImagesForMap: function(mid, callback) {
      console.log('-------------get images for map:', mid);
      return knex
        .select('image')
        .from('map_points')
        .where('m_id', mid)
    ...
    getImagesForList: function(lid, callback) {
      console.log('-------------get all images for list:', lid);
      return knex
        .select('image')
        .from('map_points')
    ...
    getAllFavListIdByUid: function(uid, callback) {
      console.log('-------------get all fav list id:', uid);
      return knex
        .select('l_id')
        .from('favourites')
        .where('u_id', uid)
    ...
    getMapIdByListId: function(lid, callback) {
      console.log("-------------get map id for list:", lid);
      return knex
        .select('m_id')
        .from('maps')
        .where('l_id', lid)
    ...
    dropContributor: function(obj, callback) {
      console.log('-------------drop contributor:', obj);
      knex('contributions')
      .where('l_id', obj.lid)
    ...
    getHistoryByMapId: function(mid, callback) {
      console.log('-------------get history for map:', mid);
      knex()
    ...
    dropHistory: function(mid) {
      console.log('-------------drop history for map', mid);
      knex('history')
      .where('m_id', mid)
      .del()
      .then();
